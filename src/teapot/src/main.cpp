...
int main()
{
    ...
    try
    {
        ...
        appData = create_semaphores(std::move(appData));
        appData = create_fences(std::move(appData));
        appData = create_command_pool(std::move(appData));
        appData = allocate_command_buffers(std::move(appData));
    }
